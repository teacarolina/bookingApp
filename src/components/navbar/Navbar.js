...
function Navbar() {
    ...
    return ( <> {
        jwt
            ? ( <>< nav className = "bg-pink-100" > <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                        ...
                        <div className="hidden sm:block sm:ml-6">
                            <div className="flex space-x-4">
                                <Link
                                    ...
                                    aria-current="page">Startsida</Link>
                                <Link
                                    to="/behandlingar"
                ...
                <Link
                    to="/"
                    className="bg-gray-900 text-pink-100 block px-3 py-2 rounded-md text-base font-medium"
                    aria-current="page">Startsida</Link>
                <Link
                    to="/behandlingar"
                        ...
                        <div className="relative flex items-center justify-between h-16">
                            ...
                            <div
                                ...
                                <Link
                                    to="/login"
                                    className="bg-gray-900 text-pink-100 px-3 py-2 rounded-md text-sm font-medium"
                                    aria-current="page">Logga in</Link>
                            </div>
                        </div>
                    </div>
